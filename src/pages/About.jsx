  ...
  return (
    <div id="about" className="about">
      <div className="container mt-5">
        <h1 data-aos="fade-right" className="text-center bd">
          About
        </h1>
        ...
        <div className="row py-5">
          ...
          <div data-aos="fade-left" className="col-md-6 pl-5  ">
            <h1 className="mt-5 mb-3 ">
              I'am <span className="text-warning">Kazi Rafi</span>{" "}
            </h1>
            <p className="lead">
              Hello I am Rafi, currently studying at Bangladesh University of
              Professionals. I am an energetic, ambitiuos person aiming to
              leverage proven creative thinking and gain new skills daily. I
              believe I am an enthusiastic and focused individual. I have a
              clear, logical mind with a practical approach to problem-solving
              and a drive to see things through to completion. I am eager to be
              challenged in order to grow and further improve my IT skills.
            </p>
            <a
              href="https://drive.google.com/file/d/1yw6GJfTEfc3V-QWqEpdVyz0NFCC6c6oY/view?usp=sharing"
